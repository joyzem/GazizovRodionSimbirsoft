...
import com.example.androidpractice.feature.news.databinding.ItemFilterBinding

internal class FiltersAdapter(private val onFilterChecked: (CategoryFilter) -> Unit) :
